...
<nav
  className={`fixed z-[1000] w-full px-5 pt-1 transition duration-300 ease-linear will-change-transform sm:px-8 sm:pt-5 ${
...
>
  <div className="flex items-center justify-between">
    ...
    <Link href="/" className="relative z-10 flex items-center">
      <h5 className="m-0 leading-none font-weight-900 max-sm:text-lg">Kaart Studio</h5>
    </Link>

    {/* Right Side: Button + Burger Menu */}
    <div className="flex items-center gap-2 sm:gap-4 lg:gap-6">
      <RevealWrapper as="div" className="flex list-none justify-center">
        <div className="md:inline-block">
          <a
            href="https://crestify.co/"
            target="_blank"
            rel="noopener noreferrer"
            /* max-md:scale-75 shrinks the button on mobile 
               origin-right keeps it tucked against the burger menu */
            className="rv-button rv-button-primary block md:inline-block max-md:scale-75 origin-right"
          >
            <div className="rv-button-top">
              <span className="max-md:text-[12px]">Back To Crestify</span>
            </div>
            <div className="rv-button-bottom">
              <span className="text-nowrap max-md:text-[12px]">Back To Crestify</span>
            </div>
          </a>
        </div>
      </RevealWrapper>

      {/* Burger Menu Button - Adjusted size for mobile screens */}
      <button
        ref={openBtnRef}
        onClick={openMenu}
        className="menu-open relative h-[50px] w-[50px] sm:h-[68px] sm:w-[68px] cursor-pointer before:absolute before:left-1/2 before:top-[42%] sm:before:top-[28px] before:h-0.5 before:w-7 sm:before:w-9 before:-translate-x-1/2 before:bg-black before:transition-all before:duration-300 before:content-[''] after:absolute after:bottom-[42%] sm:after:bottom-[28px] after:left-1/2 after:h-0.5 after:w-7 sm:after:w-9 after:-translate-x-1/2 after:bg-black after:transition-all after:duration-300 after:content-[''] hover:before:top-[25px] hover:after:bottom-[25px] dark:before:bg-white dark:after:bg-white"
